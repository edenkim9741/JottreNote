...
protocol CreateJotCoordinatorFactoryProtocol: Sendable {
    ...
    func make(navigation: Navigation, directory: CreateJotCoordinatorFactory.Directory?, pdfData: Data?) -> Coordinator
}
...
struct CreateJotCoordinatorFactory: CreateJotCoordinatorFactoryProtocol {
    ...
    func make(navigation: Navigation, directory: Directory?, pdfData: Data? = nil) -> Coordinator {
