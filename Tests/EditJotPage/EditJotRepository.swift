...
protocol EditJotRepositoryProtocol: Sendable {
    ...
    func readContent(jotFileInfo: JotFile.Info) async throws -> JotContent
    func writeContent(jotFileInfo: JotFile.Info, drawing: PKDrawing, pdfData: Data?, extraPages: Int, strokePageIndices: [Int]) async throws
